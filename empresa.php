...
<div class="linha">
    ...
    <div class="corpo-categorias">
        ...
        <h2 class="titulo">Novos Produtos em Destaque</h2>
    ...
    <div class="ofertas">
        <div class="corpo-categorias">
            <div class="linha">
                ...
                <div class="col-2">
                    <p>Produto exclusivo da loja Paulo</p>
                    <h1>Plataforma se Streaming</h1>
        ...
        <div class="corpo-categorias">
            <div class="linha">
                ...
                <div class="col-3">
                    ...
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolores maiores sit aspernatur sed itaque quos in nihil, accusantium maxime? Corrupti possimus eos voluptas facere ullam est officia eligendi inventore nisi?</p>
                    <div class="classificacao">
                        <ion-icon name="star"></ion-icon>
                        <ion-icon name="star"></ion-icon>
                        <ion-icon name="star"></ion-icon>
